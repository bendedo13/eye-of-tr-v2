...
print("\n" + "="*70)
print("🎬 ACUN ILICALI TEST USER SETUP")
print("="*70)
...
print("\n" + "="*70)
print("✅ TEST USER READY FOR ACUN ILICALI SEARCH TESTING")
print("="*70)
print(f"\n📧 Email:              {TEST_EMAIL}")
print(f"🔑 Password:           {TEST_PASSWORD}")
print(f"👤 Username:           {TEST_USERNAME}")
print(f"💳 Credits:            1000 (unlimited tier)")
print(f"🔐 JWT Token:          {jwt_token[:50]}..." if jwt_token else "🔐 JWT Token:          (Failed to generate)")
...
print("\n" + "="*70)
print("\n✅ Next steps:")
print("   1. Get 3 Acun Ilıcalı images")
