...
export async function generateMetadata({
  ...
  const title = locale === 'tr' 
    ? "FaceSeek - KVKK Uyumlu Yapay Zeka Yüz Arama Motoru" 
    : "FaceSeek - Advanced AI Facial Recognition Search Engine";
    
  const description = locale === 'tr'
    ? "Türkiye'nin en gelişmiş, KVKK uyumlu yüz tanıma ve OSINT arama motoru. Biyometrik verilerinizi saklamadan güvenli arama yapın."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": locale === 'tr' ? "KVKK Uyumlu Yüz Arama Motoru" : "AI Facial Search Engine"
          })
        }}
      />
