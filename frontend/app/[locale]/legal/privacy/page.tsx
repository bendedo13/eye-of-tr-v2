  ...
  return (
    <LegalLayout>
      <div className="space-y-10 font-sans">
        <section>
          <h1 className="text-3xl font-black mb-2 text-white">GİZLİLİK POLİTİKASI</h1>
          <p className="text-face-seek-cyan text-xs font-black uppercase tracking-widest mb-6">Son Güncelleme: 5 Şubat 2026</p>
          <p className="text-zinc-300 leading-relaxed">
            FaceSeek olarak gizliliğinize saygı duyuyoruz. Bu Gizlilik Politikası, yüz arama motorumuzu kullandığınızda verilerinizin nasıl toplandığını, kullanıldığını ve korunduğunu açıklar. KVKK ve GDPR standartlarına tam uyumluluk taahhüt ediyoruz.
          </p>
        </section>
